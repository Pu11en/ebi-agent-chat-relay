...
- [ ] 1.1 **Depends on: none; owns: `extensions/harness_audit/models.py`, `tests/test_harness_audit_models.py`.** Define versioned inventory, evidence-level, finding, classification, machine-exception, and coverage-gap records; verify schema round trips and rejects unknown required fields.
