...
- [x] 2.2 **Depends on 1.2 and 2.1; owner: migration adapter** — Map valid legacy launcher favorites/recents to catalog identities without deleting raw settings; verify tests keep unmappable paths available to the manual browser and preserve metadata across temporary absence.
