...
- [ ] 1.1 **Owner: catalog domain** — Add immutable root, project, availability, query, and resolution result types in `claude_discord/project_catalog.py`; verify focused unit tests distinguish local, unavailable, remote, ambiguous, and no-match results.
