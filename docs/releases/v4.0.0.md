...
The new [end-to-end Teams setup guide](https://github.com/Pu11en/ebi-agent-chat-relay/blob/main/docs/teams-setup.md) explains the complete path, security
...
See [Choose an agent backend](https://github.com/Pu11en/ebi-agent-chat-relay/blob/main/docs/backends.md)
and the detailed [AG-UI guide](https://github.com/Pu11en/ebi-agent-chat-relay/blob/main/docs/agui-backend.md).
...
- [README: v4 overview](https://github.com/Pu11en/ebi-agent-chat-relay#whats-new-in-v4)
- [Choose an agent backend](https://github.com/Pu11en/ebi-agent-chat-relay/blob/main/docs/backends.md)
- [Set up Microsoft Teams end to end](https://github.com/Pu11en/ebi-agent-chat-relay/blob/main/docs/teams-setup.md)
- [Microsoft Teams surface behavior](https://github.com/Pu11en/ebi-agent-chat-relay/blob/main/docs/teams.md)
- [Private-host relay security model](https://github.com/Pu11en/ebi-agent-chat-relay/blob/main/docs/teams-relay.md)
- [AG-UI backend](https://github.com/Pu11en/ebi-agent-chat-relay/blob/main/docs/agui-backend.md)
- [ADR-0006: Publish the multi-frontend platform as version 4](https://github.com/Pu11en/ebi-agent-chat-relay/blob/main/docs/adr/0006-publish-the-multi-frontend-platform-as-v4.md)
