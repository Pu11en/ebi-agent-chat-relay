...
to a free public GHCR package, and the dedicated Basic registry was deleted.
The image digest remained identical across registries. A fresh Container Apps
replica was then pulled and started after the Azure registry and its credentials
were gone; three health checks completed in 71–74 ms. This removes the
$5.1/month registry line from the table above.
